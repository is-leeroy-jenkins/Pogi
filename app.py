...
st.set_page_config(
    page_title="Pogi — Budget Execution Modeling",
    layout="wide",
)

st.title("🏛️ Pogi — Budget Execution & Forecasting")
st.markdown(
    """
    **Machine-learning modeling and diagnostics for SF-133 / Treasury Account Symbol data.**
...
st.markdown("---")
st.caption("Pogi — Budget Execution Analytics | Streamlit Application")
